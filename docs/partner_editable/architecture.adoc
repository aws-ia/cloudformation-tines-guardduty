...
* Amazon GuardDuty, AWS Lambda, Amazon EventBridge, and Amazon SNS integration with {partner-product-short-name} with GuardDuty findings being sent to a Tines webhook.
