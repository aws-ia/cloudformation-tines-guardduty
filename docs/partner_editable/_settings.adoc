...
:quickstart-project-name: cloudformation-tines-guardduty
:partner-product-name: Tines
...
:partner-contributors: John Tuckner, Tines
:quickstart-contributors: {quickstart-team-member}, {quickstart-team-name}
...
:marketplace_subscription: Software as a Service (SaaS)
:marketplace_listing_url: https://aws.amazon.com/marketplace/pp/prodview-s4qz57qacdgqs?sr=0-1&ref_=beagle&applicationId=AWSMPContessa
