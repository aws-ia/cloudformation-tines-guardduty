...
This Amazon Web Services (AWS) Partner Solution deploys [<Tines>](<https://tines.com>) in the AWS Cloud to triage GuardDuty findings effectively. This solution is for cloud security engineers who want to automate their manual repetitive tasks so that they can focus on meaningful work. For more information, refer to the [Tines documentation](<https://www.tines.com/hub>).
